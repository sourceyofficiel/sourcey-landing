  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-neutral-950 p-4">
      <div className="w-full max-w-md">
        ...
        {/* Card */}
        <div className="rounded-2xl border border-neutral-800/80 bg-neutral-900/60 p-8 shadow-2xl backdrop-blur">
          ...
          <Suspense
            fallback={
              <div className="mt-6 h-11 rounded-xl bg-neutral-800/40" />
            }
          >
            <LoginForm />
          </Suspense>
