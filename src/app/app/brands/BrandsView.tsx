  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-6 lg:px-8 lg:py-8">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        {brands.length === 0 ? (
          <div className="sm:col-span-2 rounded-2xl border border-violet-500/20 bg-gradient-to-br from-violet-500/5 to-fuchsia-500/5 p-8 text-center">
            ...
            >
              ...
              {b.brand_context && (
                <div className="mt-3 rounded-lg bg-neutral-950/60 p-2.5">
                  <div className="text-[9.5px] font-bold uppercase tracking-wider text-violet-300">
                    Contexte IA
                  </div>
                  <p className="mt-1 line-clamp-3 text-[11.5px] text-neutral-400">
                    {b.brand_context}
                  </p>
                </div>
              )}
