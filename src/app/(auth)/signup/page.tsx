...
export default function SignupPage() {
  ...
  // 2-step flow comme Notion : email d'abord, puis nom + password
  ...
  return (
    <div>
      {/* Title — two-tone (positioning + action) */}
          ...
          <form onSubmit={handleContinue} className="mt-8 space-y-4">
            <div>
              ...
              <p className="mt-1.5 text-[12px] text-neutral-500">
                Utilisez votre email perso ou pro pour gérer votre activité de
                sourcing.
              </p>
            </div>
            ...
            <button
              type="submit"
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-primary-600 text-[15px] font-semibold text-white transition-colors hover:bg-primary-700 active:bg-primary-800"
            >
              Continuer
            </button>
          </form>
      ...
      {step === 2 && (
        <form onSubmit={handleCreateAccount} className="mt-8 space-y-4">
          {/* Email récap avec bouton "Modifier" */}
          ...
          <ul className="grid gap-1.5 pt-3 text-[12px] text-neutral-500">
            <li className="flex items-center gap-2">
              ...
              On te contacte sur WhatsApp dans les 24h
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-3 w-3 text-green-600" strokeWidth={3} />
