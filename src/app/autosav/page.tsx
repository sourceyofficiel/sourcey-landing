...
/**
 * Landing AutoSAV — sous-produit hébergé temporairement sur sourcey.fr/autosav
 * pour tester. Migrera vers autosav.io quand le SaaS sortira en commercial.
 */
export default function AutosavLandingPage() {
  return (
    <main className="relative min-h-screen bg-white text-neutral-900">
      ...
      <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-5 md:px-8">
          <Link href="/autosav" className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/signup?next=/autosav/onboarding"
      ...
      <footer className="border-t border-neutral-200 px-5 py-8 md:px-8">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-3 text-[12.5px] text-neutral-500 md:flex-row">
          <p>© 2026 AutoSAV · Beta · hébergé temporairement sur sourcey.fr</p>
          <div className="flex gap-4">
            <Link href="/autosav#pricing" className="hover:text-neutral-900">
              Tarifs
            </Link>
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Pro et Agency : laisse l'IA répondre seule sur les questions simples (suivi, retour, taille). Tu garderais des nuits sereines.",
  },
  {
    icon: ShieldCheck,
