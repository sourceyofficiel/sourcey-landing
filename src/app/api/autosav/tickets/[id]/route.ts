...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      // wcOrders : chargé en parallèle via /tickets/[id]/wc-orders pour ne
      // pas bloquer la conv si WC est lent / down. Le client UI fait la 2e
      // requête après affichage du ticket.
    });
  } catch (e) {
